        ...
        >
            ...
            <div className="flex h-[90%] w-full flex-col items-end gap-2 md:h-[92%]">
                <div className="relative w-full">
                    <select
                        className="w-full rounded-md border-none bg-fileTab px-4 py-2 text-white outline-none"
                ...
                <textarea
                    className="min-h-[120px] w-full resize-none rounded-md border-none bg-fileTab p-2 text-white outline-none"
                ...
                <div className="w-full flex-grow resize-none overflow-y-auto rounded-md border-none bg-fileTab p-2 text-white outline-none">
                    <code>
